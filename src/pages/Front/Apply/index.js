...
const baseUrl = "http://localhost:3005/api/v1/applicants/";
...
const Apply = () => {
  ...
  const [pageCount, setPageCount] = useState("step-3");
  ...
  const newState = states.find(s => s.state.id === state);
  ...
  const handleSubmit = () => {
    ...
    let data = {
      ...applicant,
      caseType,
      state_orgin: newState.state.name,
      relatives: rels,
      dppAdvice: dppAdvice === 1 ? true : false
    };
    console.log(data);
    const postData = async () => {
      const newData = await axios.post(baseUrl, data);
      if (data.data.success) alert("Application was successfull");
      console.log(newData);
    };
    postData();
  };
              ...
              <div className="show" id="step-3">
                ...
                <Field className="form_group field">
                  <input
                    ...
                    required
                  />
                  <label className="form__label">Applicant's full Name</label>
                </Field>
                <Field className="form_group field">
                  <input
                    type="input"
                ...
                <Field className="form_group field">
                  <input
                    ...
                    required
                  />
                  <label className="form__label">applicant's Address</label>
                </Field>
                <Field className="form_group field">
                  <input
                    type="number"
                ...
                <div className="slc-wrp ">
                  <p className="h6">Applicant's State of Origin</p>
                  <select
                    className="d-select border-link block-select "
                    name="state_origin"
                    onChange={e => {
                  ...
                  >
                    {states.map(state => (
                      <option value={state.state.id} key={state.state.id}>
                        {state.state.name}
                      </option>
                    ))}
                  </select>
                ...
                {newState && (
                  <div className="slc-wrp ">
                    <p className="h6">Applicant's Local Goverment</p>
                    <select
                      className="d-select border-link block-select "
                      name="lga"
                      onChange={handleChange}
                ...
                <div className="slc-wrp ">
                  <p className="h6">Applicant's Gender ?</p>
                  <select
                    className="d-select border-link block-select "
                    name="gender"
                    onChange={e => {
            ...
            */}
            ...
            {pageCount === "step-4" && (
              <div className="show" id="step-4">
                <div className="slc-wrp ">
                  <p className="h6">
                    Where {person === "you" ? "are you" : `is ${person}`} ?
                  </p>
                  <select
                    type="boolean"
                    className="d-select border-link block-select "
                ...
                <div className="slc-wrp ">
                  <div className="slc-wrp ">
                    ...
                    >
                      ...
                      <option value={0}>No. But facing criminal trial </option>
                      <option value={2}>No. I am already on bail </option>
                    </select>
                  </div>
                </div>
              </div>
            ...
            {pageCount === "step-12" && !proxy && (
              <div className="show" id="step-12">
                ...
                <div className="slc-wrp ">
                  <p className="h6">State Where you were arrested</p>
                  <select
                    className="d-select border-link block-select "
                    name="state_arrested"
                    onChange={handleChange}
            ...
            {pageCount === "step-8" && (
              <div className="show">
                <div className="slc-wrp ">
                  ...
                  <select
                    ...
                    onChange={e => {
                      let { value } = e.target;
                      handleChange(e);
                      value === "false" && setPageCount("step-10");
                    }}
                  >
                    <option value={null}>Please select an option</option>
                    <option value={true}>Yes</option>
                ...
                {pageCount === "step-8" && detention_cost && (
                  <div className="form-group mt-3">
                    <p className="h6">Please explain</p>
                    <textarea
                      className="border-link rounded-0 form-control"
                      required
                      rows="8"
